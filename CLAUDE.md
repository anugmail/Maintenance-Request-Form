...
**ก่อนแตะ HTML/CSS ใดๆ ต้องอ่าน 3 ไฟล์นี้ก่อนเสมอ — ห้ามเดาจากแพตเทิร์นของหน้าที่มีอยู่**

1. [`design-system/README.md`](design-system/README.md) — กฎบังคับอยู่ที่ **หัวข้อ 0** (มี "ขั้นตอนบังคับก่อนแตะงานออกแบบ" 6 ขั้น) · รายการคอมโพเนนต์อยู่ **หัวข้อ 4**
2. [`design-system/components.css`](design-system/components.css) — คลาสจริงที่มีให้ใช้
3. [`design-system/SOURCES.md`](design-system/SOURCES.md) — **ตารางความครอบคลุม ก–ง**: ของไหนเทียบไลบรารี PEA แล้ว · ของไหนอิง screenshot · ของไหนไลบรารีมีแต่เรายังไม่ทำ (ถ้าจะทำ ให้ยกจาก node ที่ระบุไว้ ห้ามออกแบบเอง)
