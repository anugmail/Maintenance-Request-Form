...
> **เวอร์ชัน:** v0.32 (26 ส.ค. 2569) · **สถานะ:** ใช้กับทุกหน้าใน prototype แล้ว (24/24)
...
|---|---|---|
| 26 ส.ค. 2569 | v0.32 | เพิ่มตารางจัดซื้อท้ายหน้าเบิกอะไหล่ (`.parts-purchase-pane` — auto เพิ่มแถวเมื่อเบิกเกินคงคลัง + เพิ่ม/ลบแถวเองได้ ตามคอลัมน์ ลำดับ/รายการ/จำนวน/ราคาต่อหน่วย/ราคารวม/ร้านค้า/ใบสั่งซื้อ-จ้าง) · เพิ่ม **`.file-chip`** — ยกจาก Figma `3:25` File upload item (state Completed) ตัดแถบ progress ออก ไอคอนแปลงเป็น Material Symbols ตามกฎข้อ 3 (ดู SOURCES.md หมวด ง ที่ระบุไว้ว่าไลบรารีมีคอมโพเนนต์นี้แต่ยังไม่เคยทำ) · บั๊ม `?v=20260826-ds32` ทุกหน้า |
