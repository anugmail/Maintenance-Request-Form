...
- [ ] **กบก. คือหน่วยงานอะไร** ใช่ตัวเดียวกับ กบค. ไหม (ค้างมาตั้งแต่รอบก่อน)
...
| | เดิม | ใหม่ |
|---|---|---|
| ใครออกเลขงาน | ฝ่ายพัสดุ (อนุมัติ) | **กบก. กดเองที่หน้าสรุป** |
...
- ย้าย logic รายการอะไหล่ไป `MYD.linesFor()` / `MYD.planLines()` เพื่อให้หน้า กบก. กับหน้าพัสดุเห็นตัวเลข**ชุดเดียวกัน**
