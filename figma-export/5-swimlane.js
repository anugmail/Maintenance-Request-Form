...
/* ---------- สถานะ ----------
   ...
   cf = ยังไม่มี flow ต่อ (S22 กบค. ส่งอู่ — เคาะ 16 ก.ย. 2569 ว่ามีสถานะ แต่ยังไม่บอกว่าเดินยังไง) */
const NODES = [
  ...
  { id: 'S4',  lane: 'unit', col: 1,  kind: 'stadium', label: 'ตีกลับเอกสาร' },
  ...
  { id: 'S7',  lane: 'kry',  col: 3,  label: 'กรย. เห็นชอบ — รับเรื่องซ่อมเอง' },
  { id: 'S8',  lane: 'kry',  col: 3,  label: 'รอ กรย. ดำเนินการ' },
  { id: 'S9',  lane: 'kry',  col: 3,  label: 'กรย. ส่งซ่อมศูนย์บริการ/อู่' },

  { id: 'S10', lane: 'kbk',  col: 3,  label: 'รอ กบค. พิจารณา (routing ประเภทรถ × ภาค)' },
  { id: 'S11', lane: 'kbk',  col: 3,  label: 'กบค. เห็นชอบ — รับเรื่องซ่อมเอง' },
  { id: 'S22', lane: 'kbk',  col: 3,  cf: true, label: 'กบค. ส่งซ่อมศูนย์บริการ/อู่ (flow ต่อยังไม่เคาะ)' },
...
const EDGES = [
  ['A0', 'S1', ''],
  ['S1', 'S3', 'ไม่อนุมัติ'],
  ['S1', 'S4', 'ตีกลับเอกสาร ⇒ ปิดงาน'],
  ['S1', 'S2', 'อนุมัติ · ให้ต้นทางซ่อมเอง'],
  ['S1', 'S6', 'อนุมัติ · ส่งต่อ กรย.'],
  ['S2', 'S21', 'บันทึกผลซ่อม'],
  ['S2', 'S6', 'ซ่อมเองไม่ได้ · ส่งต่อ กรย.'],
  ['S6', 'S5', 'ส่งกลับต้นทาง'],
  ['S5', 'S2', ''],
  ['S6', 'S7', 'กรย. เห็นชอบ · รับเรื่องเอง'],
  ['S7', 'S8', ''],
  ['S8', 'S21', 'กรย. ซ่อมเสร็จ'],
  ['S6', 'S9', 'ส่งซ่อมศูนย์บริการ/อู่'],
  ['S9', 'S16', 'อู่ซ่อมเสร็จ · ตรวจรับ'],
  ['S6', 'S10', 'ส่งซ่อม กบค.'],
  ['S10', 'S11', 'กบค. เห็นชอบ · รับเรื่องเอง'],
  ['S10', 'S22', 'ส่งซ่อมศูนย์บริการ/อู่', 'dotted'],
  ['S11', 'S12', 'ต้องเตรียมอะไหล่'],
  ['S12', 'B1', ''],
  ['B1', 'S13', 'อะไหล่พร้อม'],
